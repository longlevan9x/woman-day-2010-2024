...
function HeartSvg({ size = 50, color = '#d7443e' }: any) {
    return (
...
function Heart({ heart, directionY = 'rise', color = '#FB5879' }: any) {
    return (
        <>
...
export function BackgroundHearts() {
    ...
    const [colors, setColors] = useState(['#FB5879', '#FC879F', '#F92A53', '#FA4166', '#F23057', '#B56C7B']);
    useEffect(() => {
        const _hearts = [];
